...
(const instr_32 instr, ref vm_t vm) {
	...
	int rd0 = vm.cpu.ge3 ? ((rn >> 24) & 0xff) : ((rm >> 24) & 0xff); 
	int rd1 = vm.cpu.ge2 ? ((rn >> 16) & 0xff) : ((rm >> 16) & 0xff); 
	int rd2 = vm.cpu.ge1 ? ((rn >>  8) & 0xff) : ((rm >>  8) & 0xff); 
	int rd3 = vm.cpu.ge0 ? ((rn      ) & 0xff) : ((rm      ) & 0xff); 
