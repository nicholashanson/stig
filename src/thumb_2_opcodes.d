...
unittest {
	...
	test_case[] tests = [
		test_case(0x415b, opcode.adc_reg_t1),
		test_case(0x4463, opcode.add_reg_t1),
		test_case(0x44e6, opcode.add_reg_t2),
		test_case(0x1d3b, opcode.add_imm_t1),
		test_case(0x3730, opcode.add_imm_t2),
		test_case(0x4413, opcode.add_reg_t1),
		...
		test_case(0x460f, opcode.mov_imm_t1),
		...
		test_case(0x1e54, opcode.sub_imm_t2),
		test_case(0x1a1b, opcode.sub_reg_t2),
...
opcode decode_load_store_mult(uint instr) {
	...
	switch (op_L) {
		case 0b011: return Wrn == 0b11101 ? opcode.pop_t2  : opcode.ldmb_t1;
		case 0b100: return Wrn == 0b11101 ? opcode.push_t2 : opcode.stmb_t1;
		case 0b101: return opcode.ldm_t2;
...
opcode decode_load_half_word(const uint instr) {
	...
	if ((op1 == 0b00) && ((op2 & 0b000000) == 0b111000) && (rn != pc) && (rt != pc)) 
...
unittest {
	...
	test_case[] tests = [
		...
		test_case(0xf5a33a80,  opcode.sub_imm_t2),
	    ...
	    test_case(0xea4f06a6,  opcode.asr_imm_t1),
	    test_case(0xf4434380,  opcode.orr_imm_t1),
		...
		test_case(0xf837c012,  opcode.ldr_imm_t2),
