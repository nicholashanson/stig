...
string convert_bkpt_t1_to_string(const ref instr_16 instr, const condition cond) {
	return format("bkpt #%d", instr.imm);
}
// ---------------------------------------------------------------------------------------
...
instr_16 parse_yield_t1(const ushort instr) {
	return instr_16();
}
...
instr_16 parse_wfe_t1(const ushort instr) {
	return instr_16();
}
...
instr_16 parse_wfi_t1(const ushort instr) {
	return instr_16();
}
...
instr_16 parse_sev_t1(const ushort instr) {
	return instr_16();
}
